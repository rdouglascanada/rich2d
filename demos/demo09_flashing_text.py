...
faster_flashing_text = Text(rect=(100, 200, 300, 50), text="Some faster flashing text", colour="white", font_size=32)
faster_flashing_text_model = FlashingText(text_sprite=faster_flashing_text, flashes_per_interval=2)
slower_flashing_text = Text(rect=(100, 300, 300, 50), text="Some slower flashing text", colour="white", font_size=32)
