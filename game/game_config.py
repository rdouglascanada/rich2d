...
class GameConfig:
    ...
    def __init__(self, background_colour=None, frame_rate=None,
                 window_icon=None, window_title=None, window_width=None, window_height=None):
        ...
        self._background_colour = pygame.Color(background_colour)
